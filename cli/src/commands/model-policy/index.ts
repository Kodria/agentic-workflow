...
export interface ModelPolicyCommandDependencies { approvePolicy?: (input: ApprovePolicyInput) => ReturnType<typeof approvePolicy>; readEffectivePolicy?: typeof readEffectivePolicy; approveCapabilities?: (input: ApproveCapabilitiesInput) => ReturnType<typeof approveCapabilities>; readCapabilities?: typeof readCapabilities; candidateDigest?: (input: CandidateDigestInput) => CandidateDigest; }
