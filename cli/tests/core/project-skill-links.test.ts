...
describe('project-scope skill links get the same integrity path as global ones', () => {
    ...
    beforeEach(() => {
        registry = mkCanonicalTmpDir('awm-projlink-reg-');
        projectRoot = mkCanonicalTmpDir('awm-projlink-proj-');
...
describe('awm sync reaches the project-scope reconciliation', () => {
    ...
    beforeEach(() => {
        jest.resetModules();
        home = mkCanonicalTmpDir('awm-syncwire-home-');
        ...
        projectRoot = mkCanonicalTmpDir('awm-syncwire-proj-');
