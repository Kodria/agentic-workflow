...
describe('aplicacion transaccional de requests', () => {
    ...
    test('routing reserve/observe es supervisado, idempotente y una generacion vieja no muta intentos', () => {
        const envelope = { schema: 'routing-envelope/v1', role: 'implementer', requestedProfile: 'mechanical', effectiveProfile: 'mechanical', policyDigest: 'a'.repeat(64), capabilityDigest: 'b'.repeat(64), planDigest: 'c'.repeat(64), executionDigest: 'd'.repeat(64) };
