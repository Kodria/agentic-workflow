...
- [x] Verificación: un proyecto pineado NO recibe cambios de main hasta bump explícito; rollback funciona (verificado 2026-06-10 con fixtures git locales + runbook manual)
- [x] QA → `awm-qa-complete` (2026-06-10) + `awm-retro-complete` (2026-06-10)
